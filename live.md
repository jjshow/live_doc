...
* 私密直播
### No.40 请求地址
http://106.75.51.187:9501/?c=live&m=start_live
### No.40 请求参数
```sh
	var param{
		"token" :	"CDfxaGtmCoTphcx5glwRoA",//用户token
		"live_type"	:	0,//0表示公开直播，1表示私密直播，
		"live_cost"	:	100,//私密直播门票费用,当门票>0时候,不允许出现live_type等于0情况,严格控制live_type和live_cost的配对值
	}
```
